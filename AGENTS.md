...
| Layer | Path | Status |
|-------|------|--------|
| Domain | `domain/{catalog,identity,kernel}/` | Catalog + identity done, cart/checkout planned |
| Application | `application/identity/` | First app service done |
| Infrastructure | `infrastructure/{catalog,identity,database,...}/` | Catalog + identity repos, custom migrator done |
| Interfaces | `interfaces/{middleware,rest}/` | UCP profile, middleware, identity handlers done |
