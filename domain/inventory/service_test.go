...
func TestInventoryService_Reserve_Insufficient(t *testing.T) {
	...
	_, _ = svc.SetStock(context.Background(), 1, 101, 10, 10)
...
func TestInventoryService_GetStock(t *testing.T) {
	...
	_, _ = svc.SetStock(context.Background(), 1, 101, 50, 10)
...
func TestInventoryService_ListLowStock(t *testing.T) {
	...
	_, _ = svc.SetStock(context.Background(), 1, 101, 5, 10)
	_, _ = svc.SetStock(context.Background(), 2, 102, 20, 10)
	_, _ = svc.SetStock(context.Background(), 3, 103, 50, 10)
...
func TestInventoryService_ReleaseAndConfirm(t *testing.T) {
	...
	_, _ = svc.SetStock(context.Background(), 1, 101, 100, 10)
	_, _ = svc.Reserve(context.Background(), 101, 40)
	_, _ = svc.ReleaseReservation(context.Background(), 101, 10)
	...
	_, _ = svc.ConfirmReservation(context.Background(), 101, 30)
	item, _ = svc.GetStock(context.Background(), 101)
